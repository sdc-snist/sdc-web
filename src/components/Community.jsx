...
const Community = () => {
  return (
    <div className="m-30 flex items-center justify-center bg-white">
      <div className="container  bg-black bg-opacity-90 p-10 md:p-20 rounded-lg grid-background space-y-2 ">
        <div className="text-center">
          ...
          <p className="text-base md:text-lg mb-6 md:mb-8 text-gray-300">
            Be part of a network that fosters innovation, knowledge sharing, and
            career growth!
          </p>
          <button className="bg-red-600 mb-5 md:mb-7 text-white py-2 md:py-3 px-6 md:px-8 rounded-full text-base md:text-lg">
            Join
          </button>
        </div>
