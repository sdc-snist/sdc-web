...
const Landing = () => {
  ...
  return (
    <section ref={ref} className={`section relative overflow-hidden min-h-[90vh] flex flex-col items-center justify-center transition-all duration-1000 ${inView ? 'animate-fade-slide' : 'opacity-0 translate-y-10'}`}> 
      ...
      >
        We <span className="text-[var(--color-primary)]">empower</span> students<br className="hidden sm:block" />
        with <span className="italic text-[var(--color-primary)]">collaboration</span>,<br className="hidden sm:block" />
        learning & new skills.
      </h1>
