    ...
    <div className="min-h-screen bg-[#fcefdc] w-full flex flex-col relative">
        <div className="w-full text-black flex flex-col items-center">
          <img
            ...
            className="absolute z-10 w-full max-w-[1000px] h-auto top-40 sm:top-44 md:top-48 lg:top-[181px]"
          />

          <div className="absolute top-[549px] right-[196px] w-[115.27px] h-[130px] hidden md:block">
            <img src={nodeLogo} alt="NodeJS" className="w-full h-full object-contain" />
          </div>
          <div className="absolute top-[223px] left-[160px] w-[56.75px] h-[64px] hidden md:block">
            <img src={nodeLogo} alt="NodeJS2" className="w-full h-full object-contain" />
          </div>
          <div className="absolute top-[338px] left-[28px] w-[115px] h-[115px] hidden md:block">
            <img src={jsLogo} alt="JavaScript" className="w-full h-full object-contain" />
          </div>
          <div className="absolute top-[423px] right-[81px] w-[59px] h-[59px] hidden md:block">
            <img src={jsLogo} alt="JavaScript2" className="w-full h-full object-contain" />
          </div>
          <div className="absolute top-[490px] left-[33px] w-[219px] h-[219px] hidden md:block">
            <img src={mongoLogo} alt="MongoDB" className="w-full h-full object-contain" />
          </div>
          <div className="absolute top-[381px] right-[234px] w-[109px] h-[109px] hidden md:block">
            <img src={mongoLogo} alt="MongoDB2" className="w-full h-full object-contain" />
          </div>
          <div className="absolute top-[410px] left-[174px] w-[214px] h-[107px] hidden md:block">
            <img src={mernLogo} alt="MERN stack" className="w-full h-full object-contain" />
          </div>
          <div className="absolute top-[201px] right-[81px] w-[214px] h-[107px] hidden md:block">
