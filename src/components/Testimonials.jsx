  ...
  const clients = [
    {
      ...
      rating: 4.8,
      review:
        "This community has been a game-changer for my career. The resources and support are unmatched.",
    ...
    },
    {
      ...
      rating: 4.7,
      review:
        "I've learned so much from the webinars and workshops. Highly recommend joining!",
    ...
    },
    {
      ...
      rating: 4.9,
      review:
        "The networking opportunities are fantastic. I've connected with so many like-minded professionals.",
    ...
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {clients.map((client, index) => (
          <div
            key={index}
            className="bg-white p-6 rounded-lg shadow-lg border-t-4 border-red-500 transform transition duration-500 hover:scale-105"
          >
